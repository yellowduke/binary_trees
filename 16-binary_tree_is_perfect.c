 ...
 *
 * Return: This will return 1 if binary tree is perfect, else return 0
 */
...
/**
 * custom_binary_tree_height -This will Measure the height
...
/**
 * binary_tree_size -This will measure the size of a
...
/**
 * get_power -This will get the power of 2 for a given number
 * @exp: exponent
 *
